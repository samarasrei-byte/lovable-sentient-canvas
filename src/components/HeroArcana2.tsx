...
export const HeroArcana2 = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden w-full">
      {/* Navigation */}
      <nav className="absolute top-0 left-0 right-0 z-50 px-5 md:px-8 <nav className="absolute top-0 left-0 right-0 z-50 px-5 md:px-8 pt-4 md:pt-6 pb-4 safe-area-top w-full"> pb-4 safe-area-top w-full">
