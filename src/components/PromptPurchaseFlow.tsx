...
const processImageForAudit = async (file: File): Promise<File> => {
  ...
  // Client-side resizing for performance (Scientific Audit Finding: Large images cause timeouts on mobile)
    ...
    reader.onload = (event) => {
      ...
      img.onload = () => {
        ...
        canvas.toBlob((blob) => {
          ...
          const resizedFile = new File([blob], processedFile.name, {
            type: 'image/jpeg',
                ...
                {paymentStatus === 'paid' ? (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className="space-y-3"
                    >
                      <h3 className="text-xl sm:text-3xl font-black tracking-tight bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent px-4 leading-tight">
