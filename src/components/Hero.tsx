...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        {/* Headline */}
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-7xl font-bold mb-6 md:mb-8 bg-gradient-to-r from-primary via-[#6366F1] to-secondary bg-clip-text text-transparent leading-tight">
          A próxima geração de conexões entre marcas e criadores.
        </h1>

        {/* Subheadline */}
        <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-muted-foreground mb-8 md:mb-12 font-light tracking-wide max-w-4xl mx-auto px-2">
