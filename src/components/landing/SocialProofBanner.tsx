...
import { Star, TrendingUp, Users, Zap, Shield, Award } from "lucide-react";

const stats = [
  { icon: TrendingUp, value: "1B+", label: "Views gerados", color: "text-primary" },
  { icon: Users, value: "50K+", label: "Creators ativos", color: "text-secondary" },
  { icon: Zap, value: "R$21", label: "Por geração", color: "text-primary" },
...
export const SocialProofBanner = () => {
  return (
    <section className="relative py-12 border-y border-primary/10 bg-gradient-to-r from-primary/5 via-transparent to-secondary/5 overflow-hidden">
